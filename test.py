...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton.setGeometry(QtCore.QRect(80, 200, 81, 26))
        self.pushButton.setObjectName("pushButton")
        self.cameraArea = QtWidgets.QLabel(self.centralwidget)
        self.cameraArea.setGeometry(QtCore.QRect(90, 260, 111, 71))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.cameraArea.setText(_translate("MainWindow", "camera"))
